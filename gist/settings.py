...
TEMPLATES = [
    {
        ...
        'DIRS': [(os.path.join(BASE_DIR, 'stash/templates/')),],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'stash/media/')
MEDIA_URL  = '/media/'
...
OPENAI_SYSTEM_TUNER = "Your job is to cut down on the number of emails a user needs to sort through. You are creating a briefing on this email so the user shouldn't have to read the full email."
